...
function getPopularCategories(products) {
  ...
  const filterProducts =  products.filter(product => product.sales > 5)
  const sortProducts =  filterProducts.sort((a, b) => b.sales - a.sales);
  const uniqueCategories = sortProducts
